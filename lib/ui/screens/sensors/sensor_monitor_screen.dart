...
class _SensorMonitorScreenState extends State<SensorMonitorScreen> {
  ...
  Widget _buildSensorSelector() {
    final sensors = [
      ...
      {'id': 'flame', 'name': 'Flame', 'icon': Iconsax.warning_2},
      {'id': 'light', 'name': 'LDR', 'icon': Iconsax.lamp_charge},
      {'id': 'rain', 'name': 'Rain', 'icon': Iconsax.cloud_drizzle},
      {'id': 'voltage', 'name': 'Voltage', 'icon': Iconsax.flash_1},
      {'id': 'current', 'name': 'Current', 'icon': Iconsax.electricity},
    ];
  ...
  Widget _buildSensorGrid(DeviceProvider deviceProvider) {
    final allSensors = [
      ...
      _SensorData(
        id: 'flame',
        name: 'Flame',
        value: deviceProvider.flameDetected ? 1.0 : 0.0,
        unit: '',
        ...
        maxValue: 1,
        isBoolean: true,
        booleanLabels: ['No Flame', 'Flame Detected'],
      ),
      _SensorData(
        id: 'light',
        name: 'LDR Level',
      ...
      _SensorData(
        id: 'rain',
        name: 'Rain',
        value: deviceProvider.rainDetected ? 1.0 : 0.0,
        unit: '',
        ...
        maxValue: 1,
        isBoolean: true,
        booleanLabels: ['Dry', 'Rain Detected'],
      ),
      _SensorData(
        id: 'voltage',
        name: 'Voltage',
        value: deviceProvider.voltage,
        unit: 'V',
